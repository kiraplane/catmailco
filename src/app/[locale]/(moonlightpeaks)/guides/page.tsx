        ...
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_264px]">
          <div className="min-w-0 space-y-8">
            <header className="max-w-3xl space-y-4">
              ...
              <p className="text-lg leading-8 text-[#DED2F6]">
                {content.intro}
              </p>
            ...
            <AdsterraAdFrame
              slot="banner-728x90"
              className="rounded-lg border border-[#4B315F] bg-[#1D102A] py-4"
              label
            />
            ...
            <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
              {guides.map((guide) => (
                <article
                  key={guide.slug}
                  className="overflow-hidden rounded-lg border border-[#4B315F] bg-[#1D102A]"
                >
                  <div className="relative aspect-video border-[#4B315F] border-b">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#120719]/80 to-transparent" />
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {guide.tags.slice(0, 2).map((tag) => (
                        <Badge
                          key={tag}
                          variant="outline"
                          className="border-[#4B315F] text-[#F4EAFE]"
                        >
                          {tag}
                        </Badge>
                      ))}
