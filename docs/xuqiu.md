...
moonlight peaks这个个游戏的攻略站。所以我希望满足用户的攻略相关的需求。网站的名称就叫
moonlight peaks
本项目网站的网址域名为：www.moonlightpeaks.org
网站的关键词要有moonlight peaks、moonlight peaks wiki、moonlight peaks guides等
将原文件夹内容做改造，没用的内容剔除，只服务moonlightpeaks
...
3.官方商店是：https://store.steampowered.com/app/2209900/Moonlight_Peaks/
...
5.这个游戏是支持很多平台的，可以基于此说些说明，应该有不同平台的搜索词，希望可以覆盖获取流量
这个似乎是官网:https://www.moonlightpeaks.com/

6.开发完成后在github上创建仓库moonlightpeaks，将本项目上传
7.在cloudflare上面的worker创建项目moonlightpeaks部署并关联域名，域名我已经加好
